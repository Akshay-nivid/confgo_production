...
console.log(data)
  ...
  return (
    ...
    <Grid size={12} className="otpcomponent__header-wrapper">
      <Typography textAlign={'center'} className="otpcomponent__header-title">Verify Your Account</Typography>
      <Typography textAlign={'center'} className="otpcomponent__header-description ">
      ...
      <form noValidate onSubmit={handleSubmit(onSubmit)} className="form">
          <Grid className="otpcomponent__otp-input-container">
            ...
            {errors.otp?.message && <Typography className="otpcomponent__error-text">{errors.otp.message}</Typography>}
          </Grid>
      ...
      <Grid display={'flex'} justifyContent={'center'} size={12} className="otpcomponent__already-have-account-link-wrapper">
      <Typography textAlign={'center'} className="otpcomponent__already-have-account-text">
          Didn't receive the code?
          <span className="otpcomponent__signup-now-text">
