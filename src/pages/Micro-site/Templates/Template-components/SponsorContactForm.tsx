    ...
    */
    ...
    return (
        <Grid container className={clsx('sponsor-page',customStyle)} size={{ lg: 12 }}>
            <Typography className='form-header' ml={1} variant='h4'>Become Sponsor</Typography>
                        ...
                        <form className='w-full' noValidate onSubmit={handleSubmit(onSubmit)} >
                            <Grid container size={{ lg: 12, xs: 12 }} spacing={3} justifyContent='center' alignItems='center'>
                                <Grid size={{ lg: 6, xs: 12 }}  >
                                    ...
                                    <CustomTextField
                                        className={clsx("sponsor-form-label-input",customStyle+"-input")}
                                        name='name'
                                ...
                                <Grid size={{ lg: 12, xs: 12 }}>
                                    ...
                                    <TextareaAutosize
                                          className={clsx("sponsor-form-label-input",customStyle+"-textarea")}
                                        aria-label=""
                                ...
                                <Grid size={{ lg: 12, xs: 12 }} container justifyContent={"center"} alignItems={"center"}>
                                    <Grid container size={4}>
                                        <CustomButton
                                            isLoading={isLoading}
                                            size='large' fullWidth type='submit' className={clsx('sponsor-form-submit-button',customStyle+'-button')} disabled={recapcha} label='Submit'></CustomButton>
                                    </Grid>
                                </Grid>
                            </Grid>
                        </form>
...
export default SponosrContactForm;