...
const T6priceTier = () => {
    ...
    return (
        <>
            {isEventPriceTiers ? <Box >
                <Box id={'tickets'} className='main t6-tier-section'>
                    <h3 className='template-section-title t6-tier-section-title '>Registration & Ticketing</h3>
                    <Grid container columnSpacing={6}  rowSpacing={4} className='tiers-container'>
                                                ...
                                                data && Object?.entries(data)?.map(([key, priceTier], index: number) => {
                                                    ...
                                                    return (
                                                        <Grid  size={{ xs: 12, md: 6 }}>
                                                            <Grid key={key} className={clsx('tier-item', isEven ? 'even-item' : 'odd-item')}>
