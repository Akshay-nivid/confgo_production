 ...
 * 
 * Displays details of an upcoming event, including its name, date, location, 
    ...
    return (
        ...
        <Grid container height={"max-content"} size={12} spacing={1} className="adminDashBoard-upComing-Events">
            ...
            <Grid size={12} className="adminDashBoard-upComing-Events-header" container  >
                ...
                <Grid size={6} container alignItems={"center"}> <Typography className="header-title">Upcoming Event</Typography></Grid>
