...
import SingleEvent from "./SingleEventDetail";
...
const EventInfoCard: React.FC<any> = React.memo(
  ...
  return (
    <Grid container className="event-detail-event-info-card" spacing={2}>
      <SingleEvent count={eventData?.programs?.length || 0} title={"Programms"} description={"Sessions, panels & workshops"} icon={<EventDetailProgram className="single-event-icon"/>}/>
      <SingleEvent count={eventData?.eventSponsors?.length || 0} title={"Sponsors"} description={"Event partners & supporters"} icon={<EventDetailSponsor className="single-event-icon"/>}/>
      <SingleEvent count={eventData?.eventSpeakers?.length || 0} title={"Speakers"} description={"Experts & keynote guests"} icon={<EventDetailSpeaker className="single-event-icon"/>}/>
      <SingleEvent count={eventData?.registeredParticipants || 0} title={"Registered attendees"} description={"Number of attendees Registered"} icon={<EventDetailAttendee className="single-event-icon"/>}/>
      <Grid
        size={{ xs: 12 }}
        container
