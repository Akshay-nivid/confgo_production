                     ...
                     <Grid size={12} container justifyContent={"flex-start"} alignItems={"center"}>
                      ...
                      <Grid size={{ xs: 12, sm: 12 }}>
                        <CustomTextField
                          ...
                          name="venueName"
                          type="text"
                          shrink={watch('venueName')!==''&&watch('venueName')!==undefined}
                      ...
                      <Grid size={{ xs: 12, sm: 12 }}>
                        <CustomTextField
                          ...
                          name="address"
                          type="text"
                          shrink={watch('address')!==''&&watch('address')!==undefined}
                          rules={{ required: watch("type") === "OFFLINE" }}
                        />
                      </Grid>
                      <Grid size={{ xs: 12, sm: 12 }}>
                      <CustomTextField
                          ...
                          control={control}
                          type="text"
                          shrink={watch('country')!==''&&watch('country')!==undefined}
                        />
                      </Grid>
                      <Grid size={{ xs: 12, sm: 12 }}>
                         <CustomTextField
                      ...
                      <Grid size={{ xs: 12, sm: 12 }}>
                        <CustomTextField
                          ...
                          name="postalCode"
                          type="text"
                          shrink={watch('postalCode')!==''&&watch('postalCode')!==undefined}
                          rules={{
