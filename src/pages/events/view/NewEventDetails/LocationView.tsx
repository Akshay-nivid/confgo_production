    ...
    return (
        <Grid className="main-location-Views" container spacing={0} size={12} >
            ...
            {eventData?.eventClass === "OFFLINE" && (
                <Grid size={12} className="main-location-Views-address">
                    <Typography className="title-address">
            ...
            <Grid size={12} container justifyContent={"flex-end"}>
                ...
                <CustomButton className="main-location-Views-edit-btn" onClick={locationEdit} label={"Edit Venue Details"} />
